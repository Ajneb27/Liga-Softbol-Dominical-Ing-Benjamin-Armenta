# ==========================================
# SECCIÓN: 🏆 LÍDERES (RECONSTRUIDA COMPLETA)
# ==========================================
elif menu == "🏆 Líderes":
    ...
    with t1:
        ...
        if not df_b.empty:
            ...
            # Fila 1: Porcentaje y Hits Totales
            c1, c2 = st.columns(2)
            with c1:
    ...
    with t2:
        ...
        if not df_p.empty:
            # Cálculos de Pitcheo (Efectividad a 7 entradas)
            ...
            with cp1:
                ...
                # Solo mostrar pitchers con innings lanzados
