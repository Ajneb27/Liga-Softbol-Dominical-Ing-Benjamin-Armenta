...
menu = st.sidebar.radio("IR A:", ["🏠 Inicio", "🏆 TOP 10 LÍDERES", "📋 Rosters por Equipo", "🏃 Estadísticas (Admin)", "👥 Equipos"])

# ==========================================
# SECCIÓN: INICIO (LOGO, GALERÍA Y CALENDARIO)
# ==========================================
if menu == "🏠 Inicio":
...
# ==========================================
# SECCIÓN: ROSTER (ACTUALIZACIÓN INSTANTÁNEA)
# ==========================================
